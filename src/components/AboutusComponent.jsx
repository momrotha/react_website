...
const AboutusComponent = () => {
  return (
    <div className="bg-white mt-20 ">
      <header className="bg-pink-100 text-black text-center py-12">
      ...
      <section className="bg-pink-100 text-black py-12 px-4">
      ...
      <section className="bg-pink-100 text-black text-center py-12 px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mt-8 max-w-5xl mx-auto">
          <div className="p-4 shadow-lg rounded-lg bg-pink-200 hover:bg-pink-300 transition-colors">
            <p>
      ...
      <footer className="bg-pink-100 mb-10 text-black text-center py-8">
        <p>
